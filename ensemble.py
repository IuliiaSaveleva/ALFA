...
def cross_validate_ensemble_parameters(ensemble, map_computation):
    ...
    iou_threshold_values = [0.75]
    iou_power_values = [0.25]
    empty_epsilon_values = [0.4]
    ...
    cross_validation_ensemble_detections_filename = os.path.join(cache_dir,
                            'cross_validation/' +  '_'.join(detectors_names) + '_validation_ensemble_detections.txt')
    cross_validation_ensemble_full_detections_filename = os.path.join(cache_dir,
                        'cross_validation/' + '_'.join(detectors_names) + '_validation_ensemble_full_detections.pkl')
